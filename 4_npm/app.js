...
// we can either app dependencies for development or for deployement.

// to add just for development in current project we use --save-dev command.

// to add proper deployment in current project we use --save command.

// to install it globally we use -g

// we can delete the node_modules and add them again when we need it by using 'npm install'. This command installs all the dependencies required for the project.

// package-lock.json files store the exact version of modules.
