...
const {name,age} = person; // this will store the person.name to name and person.age to age using object destructuring. Note that the object where we store the properties should have the same as the property of that object.
